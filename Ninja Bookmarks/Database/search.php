...
if(isset($_POST['go'])){
	...
	if($count>0){
        ...
        . "<a href= '".$row['url']."'target='_blank'>"."<div class ='visit'>Visit Site</div>"."</a></div>"."<div class ='note'>"."<span id='note_title'>Note</span> <br><br><div class ='note_display'> ".$row['note']."</div></div>"."</div>"."<br><br><br>";
